...
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\algorithm\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\algorithm\tree\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\algorithm\cgd\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\algorithm\cartegw\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\algorithm\shawn\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\examplealg\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\gui\*.java 
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\graph\*.java
set JF2=%JF2% %SRCR%\ui\ohv\VGJ\*.java
set JF2=%JF2% %SRCR%\ui\ohv\*.java
set JF2=%JF2% %SRCR%\ui\ohv\util\*.java
