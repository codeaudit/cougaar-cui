   ...
   **/
   ...
   // this will give the initial size
      ...
      private void moveX_(int x, int y)
      {
         ...
         getParent().postEvent(new Event((Object)this, ANGLE,
			new DPoint(theta_, phi_)));
      }
      ...
      {
         graphics.drawLine((int)markx_ - 3, (int)marky_ - 3,
            (int)markx_ + 3, (int)marky_ + 3);
         graphics.drawLine((int)markx_ - 3, (int)marky_ + 3,
            (int)markx_ + 3, (int)marky_ - 3);
      }
      ...
      public boolean mouseUp(Event e, int x, int y)
      {
         ...
         getParent().postEvent(new Event((Object)this, DONE,
			new DPoint(theta_, phi_)));
         return true;
      }
