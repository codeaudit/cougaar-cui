...
*/
   ...
   import org.cougaar.lib.uiframework.ui.ohv.VGJ.graph.Edge;
...
**/
   ...
   // the scroll offsets - screen position + offset = physical position
      ...
      public double hSpacing = 5, vSpacing = 30;
  ...
  public synchronized void paintOver()
     ...
     // Draw selected or unselected objects.
                                          ...
                                          int which_gr)
      {
         ...
         graphics.drawString(canvastitle, (int)(width_ / 2) , 20);
      // Draw nodes.
...
//                   setNodeProperties(false);
      ...
      public boolean mouseDrag(Event e, int x_in, int y_in)
      {
         ...
         /*
         System.out.println("in mouseDrag ... else if(currentMouseAction_ ["
                  +currentMouseAction_+"] == 3 && selectedNode_ ["
                  +selectedNode_+"] != null && getMouseDraggingState() ["
                  +getMouseDraggingState()+"])");   /* */
	 ...
	 if (dblClickEdit.equalsIgnoreCase("true")) {
      ...
      public void selectNodeFromIndex(int node_index) {
        System.err.println("GraphCanvas selectNodeFromIndex "+node_index);
         Node node = graph_.getNodeFromIndex(node_index);
      ...
      public void selectNode(int node_index) {
        System.err.println("GraphCanvas selectNode "+node_index);
