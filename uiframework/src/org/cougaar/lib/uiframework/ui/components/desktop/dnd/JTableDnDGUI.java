...
import org.cougaar.lib.uiframework.ui.components.desktop.TableModel;
import org.cougaar.lib.uiframework.ui.components.desktop.CNMTableModel;
import org.cougaar.lib.uiframework.ui.components.desktop.ClusterNetworkMetrics;
import org.cougaar.lib.uiframework.ui.components.graph.*;

import org.cougaar.lib.uiframework.ui.components.drilldown.*;
import org.cougaar.lib.uiframework.ui.components.CChart;

public class JTableDnDGUI extends org.cougaar.lib.uiframework.ui.components.desktop.ComponentFactory implements org.cougaar.lib.uiframework.ui.components.desktop.CougaarDesktopPropertiesUI, DropTarget, DragSource
{
  ...
  public void dropData(Component componentAt, Point location, DataFlavor flavor, Object data)
  {
  	...
  	try
  	{
	  	if(flavor.getRepresentationClass() == Class.forName("org.cougaar.lib.uiframework.ui.components.graph.DataSet"))
	  	{
		  	table.setModel(tm);
	    ...
	    else if(flavor.getRepresentationClass() == Class.forName("org.cougaar.lib.uiframework.ui.components.desktop.ClusterNetworkMetrics"))
	    {
