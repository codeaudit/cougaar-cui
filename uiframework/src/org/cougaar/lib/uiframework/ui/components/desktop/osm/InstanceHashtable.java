 ...
 *  
 * CHANGE RECORD 
 * - 1 September 2001: modified by CSE to be used in place of a normal hashtable
 *   this hashtable keys on origianl hash code value of keys, not their overridden
 *   hash code value.  This only works on JVMs that have unique hash codes per
 *   object instance.
 * </copyright> 
 */
 ...
 * of the org.cougaar.lib.uiframework.ui.components.desktop.osm.Collections returned by all of InstanceHashtable's "collection view methods"
...
//	    }
    ...
    public Set keySet() {
	if (keySet == null)
	    keySet = org.cougaar.lib.uiframework.ui.components.desktop.osm.Collections.synchronizedSet(new KeySet(), this);
	return keySet;
    }
    ...
    public Set entrySet() {
	if (entrySet==null)
	    entrySet = org.cougaar.lib.uiframework.ui.components.desktop.osm.Collections.synchronizedSet(new EntrySet(), this);
	return entrySet;
    }
...
//            int hash = key.hashCode();
	...
	if (values==null)
	    values = org.cougaar.lib.uiframework.ui.components.desktop.osm.Collections.synchronizedCollection(new ValueCollection(),
                                                        this);
        return values;
    }
