 ...
 */
public class OpenMapCFrame extends OpenMapFrame implements Printable
{
    /**
     * Default constructor.  Create new OpenMapCFrame without any contents
     * or title.
     */
    public OpenMapCFrame()
    {
        super();
     ...
     *             and feel
     */
    public OpenMapCFrame(String title, boolean plaf)
    {
        super(title);
   ...
   // Graphically print the component to the printer
    ...
    private class ChangeLookAndFeelAction extends AbstractAction {
        OpenMapCFrame swingset;
        String laf;
        protected ChangeLookAndFeelAction(OpenMapCFrame swingset, String laf) {
            super("ChangeTheme");
    ...
    private class ChangeThemeAction extends AbstractAction {
        ...
        protected ChangeThemeAction(OpenMapCFrame swingset, DefaultMetalTheme theme) {
            super("ChangeTheme");
            this.swingset = swingset;
            this.theme = theme;
        }
    ...
    private class CloseAction extends AbstractAction {
        OpenMapCFrame cframe;
        protected CloseAction(OpenMapCFrame cframe) {
            super("CloseAction");
            this.cframe = cframe;
        }
    ...
    private class ExitAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            int selection = JOptionPane.showConfirmDialog(OpenMapCFrame.this,
