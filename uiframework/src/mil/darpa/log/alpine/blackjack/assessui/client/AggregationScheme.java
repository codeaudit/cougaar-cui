...
public class AggregationScheme
{
    ...
    public DatabaseTableModel.Combiner getCombiner(int aggMethod)
    {
        switch (aggMethod)
        {
            case SUM: return new AdditiveCombiner();
            case MIN: return new MinCombiner();
            case MAX: return new MaxCombiner();
            case AVG: return new AverageCombiner();
            case WAVG: return new WeightedAverageCombiner(true);
            case FONE: return new FurthestFromOneCombiner();
        }

        return null;
    }

    private abstract class FloatCombiner implements DatabaseTableModel.Combiner
    {
    ...
    private class FurthestFromOneCombiner extends FloatCombiner
    {
    ...
    private class MinCombiner extends FloatCombiner
    {
        protected float combine(float f1, float f2)
        {
    ...
    private class MaxCombiner extends FloatCombiner
    {
        protected float combine(float f1, float f2)
        {
    ...
    private class AdditiveCombiner extends FloatCombiner
    {
        protected float combine(float f1, float f2)
        {
            return f1 + f2;
