...
set LIBPATHS=%LIBPATHS%;e:\Projects\BlackJackUI\bin
set LIBPATHS=%LIBPATHS%;e:\Projects\BlackJackUI\uiframework.jar
...
java -Djava.compiler=NONE -Dinventory.testObject=no -classpath %LIBPATHS% org.cougaar.lib.uiframework.ui.inventory.InventoryChartUI  f blackjackObject c "3-FSB.MEAL READY-TO-EAT:NSN/8970001491094" l 4
